...
/**
 * Plantilla XLSX descargable para imports de entry_authorizers.
 *
 * Columnas:
 ...
 */
class EntryAuthorizersImportTemplate implements FromArray, WithEvents
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $commentCode->getText()->createTextRun(
                    __('entry_authorizers.code_help')
                );
