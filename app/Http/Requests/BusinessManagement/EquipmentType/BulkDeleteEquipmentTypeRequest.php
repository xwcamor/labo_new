...
class BulkDeleteEquipmentTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:equipment_types.delete ya gatea la ruta â€” este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('equipment_types.delete') ?? false;
    }
