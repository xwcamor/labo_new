...
class EditAllUpdateEquipmentTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $max = (int) config('equipment_types.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podÃ­a mandar name:"" y el equipmentType quedaba sin nombre
