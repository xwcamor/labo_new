...
class BulkDeleteInstrumentRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:instruments.delete ya gatea la ruta — este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('instruments.delete') ?? false;
    }
