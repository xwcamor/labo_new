...
class EditAllUpdateSamplerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $max = (int) config('samplers.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podÃ­a mandar name:"" y el sampler quedaba sin nombre
