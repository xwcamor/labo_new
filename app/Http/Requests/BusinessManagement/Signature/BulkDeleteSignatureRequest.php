...
class BulkDeleteSignatureRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:signatures.delete ya gatea la ruta â€” este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('signatures.delete') ?? false;
    }
