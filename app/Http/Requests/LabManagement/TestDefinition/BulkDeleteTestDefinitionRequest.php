...
class BulkDeleteTestDefinitionRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:test_definitions.delete ya gatea la ruta — este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('test_definitions.delete') ?? false;
    }
