...
class EditAllUpdateTestDefinitionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $max = (int) config('test_definitions.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podía mandar name:"" y el testDefinition quedaba sin nombre
