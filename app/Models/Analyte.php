...
class Analyte extends Model
{
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla analytes.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('analytes.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('analytes.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('analytes.is_active'), 'type' => 'boolean', 'operators' => ['=']],
