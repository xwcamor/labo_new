...
/**
 * EquipmentType — catálogo de tipos de transformador (Potencia, Distribución, Horno…).
 *
 * Es a la vez:
...
class EquipmentType extends Model
{
    ...
    protected string $auditModule = 'equipment_types';
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla equipment_types.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('equipment_types.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('equipment_types.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('equipment_types.is_active'), 'type' => 'boolean', 'operators' => ['=']],
