...
/**
 * Sampler — catálogo de marcas/fabricantes de transformadores (ABB, Siemens…).
 *
...
class Sampler extends Model
{
    ...
    protected string $auditModule = 'samplers';
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla samplers.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('samplers.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('samplers.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('samplers.is_active'), 'type' => 'boolean', 'operators' => ['=']],
