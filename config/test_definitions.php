...
/*
|--------------------------------------------------------------------------
| TestDefinitions module — tunable knobs
|--------------------------------------------------------------------------
|
| Modulo TestDefinitions (per-tenant): las 29 pruebas del laboratorio.
...
return [
     ...
     */
    'bulk_async_threshold' => env('TEST_DEFINITIONS_BULK_ASYNC_THRESHOLD', 200),

    /**
     * Undo despues de delete — segundos durante los cuales el usuario
     * puede hacer click en "Deshacer" para restaurar lo eliminado.
     */
    'undo_window_seconds' => env('TEST_DEFINITIONS_UNDO_WINDOW', 60),

    /**
     * Recent items — cuantos registros vistos guardar por usuario.
     */
    'recent_views_keep' => env('TEST_DEFINITIONS_RECENTS_KEEP', 10),
     ...
     */
    'export_limits' => [
        'csv'   => env('TEST_DEFINITIONS_EXPORT_LIMIT_CSV',   0),
        'excel' => env('TEST_DEFINITIONS_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('TEST_DEFINITIONS_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('TEST_DEFINITIONS_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('TEST_DEFINITIONS_EXPORT_MEMORY', '512M'),
];
