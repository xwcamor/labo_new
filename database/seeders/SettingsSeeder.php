...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'app.name',              'name' => 'Nombre de la aplicación',  'type' => 'string', 'value' => 'LaboRep', 'group' => 'app', 'description' => 'Nombre comercial mostrado en login, header, emails y título del browser.'],
