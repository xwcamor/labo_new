 ...
 */
export const analytesTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('analytes.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('analytes.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
