 ...
 */
export const entryAuthorizersTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('entry_authorizers.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('entry_authorizers.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
