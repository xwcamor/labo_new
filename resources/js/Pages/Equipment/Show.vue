                ...
                <Card :bodyStyle="{ padding: 18 }" class="info-card">
                    ...
                    <div class="spec-grid">
                        ...
                        <div v-if="isSuper" class="spec-cell">
                            ...
                            <span class="spec-cell__value"><code class="muted">{{ equipment.slug }}</code></span>
                        </div>
                        <div class="spec-cell">
                        ...
                        <div v-if="equipment.code" class="spec-cell">
                            <span class="spec-cell__label">{{ $t('equipment.code') }}</span>
                            <span class="spec-cell__value"><code>{{ equipment.code }}</code></span>
                        </div>
