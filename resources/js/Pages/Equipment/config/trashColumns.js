 ...
 */
export const equipmentTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('equipment.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('equipment.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
