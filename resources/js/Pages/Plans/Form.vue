...
import {
    Form, FormItem, Input, InputNumber, Switch, Alert, Tag, Modal,
    ...
    <div class="form-page sap-form">
        ...
        <div class="form-body">
            <Form layout="vertical" @submit.prevent="submit">
                ...
                <!-- Identidad del plan (incluye icono + color + preview en vivo) -->
                <h2 class="form-section-title">{{ $t('plans.section_identity') }}</h2>
                <div class="form-grid">
                    <FormItem
                        :required="!isEdit"
                    ...
                    >
                        <Input v-model:value="form.name" :maxlength="100" :placeholder="$t('plans.name_placeholder')" />
                    </FormItem>
                    <FormItem
                    ...
                    >
                        <Input v-model:value="form.tagline" :maxlength="200" :placeholder="$t('plans.tagline_placeholder')" />
                    </FormItem>
                    <FormItem
                        :label="$t('plans.icon')"
                    ...
                    >
                        <Select v-model:value="form.color" :placeholder="$t('plans.color_placeholder')">
                ...
                <!-- Límites numéricos -->
                <h2 class="form-section-title form-section-title--spaced">{{ $t('plans.section_limits') }}</h2>
                ...
                <div class="form-grid">
                    ...
                    >
                        <Select v-model:value="form.support_level" :placeholder="$t('plans.support_level_placeholder')">
                            <SelectOption
                ...
                <!-- Pricing -->
                <h2 class="form-section-title form-section-title--spaced">{{ $t('plans.section_pricing') }}</h2>
                <div class="form-grid">
                    <FormItem
                ...
                <!-- Features bool -->
                <h2 class="form-section-title form-section-title--spaced">{{ $t('plans.section_features') }}</h2>
                ...
                <div v-for="g in featureGroups" :key="g.title" class="feature-group">
                    ...
                    <div class="form-grid">
                        <div v-for="key in g.keys" :key="key" class="feature-row">
                ...
                <!-- Activo / Público -->
                <h2 class="form-section-title form-section-title--spaced">{{ $t('plans.section_visibility') }}</h2>
                <div class="form-grid">
