 ...
 */
export const samplersTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('samplers.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('samplers.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
