        ...
        <EntityShowTabs :show-history="canSeeAudit" :history-count="activity.length">
            <template #general>
                <Card :bodyStyle="{ padding: 14 }" class="info-card">
                    <template #title><ThunderboltOutlined /> {{ $t('global.general_info') }}</template>
                    <div class="spec-grid">
                        ...
                        <div v-if="isSuper" class="spec-cell spec-cell--id">
                            ...
                            <span class="spec-cell__value">{{ tapChangerTechnology.slug }}</span>
                        </div>
                        <div class="spec-cell">
