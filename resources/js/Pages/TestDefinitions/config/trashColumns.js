 ...
 */
export const testDefinitionsTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('test_definitions.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('test_definitions.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
