...
return [
    ...
    'code' => 'Reception no.',
    'code_help' => 'Generated on save (REC-year-number). Not the sample number.',
    'code_auto' => 'Generated on save',
    'service_order' => 'Service order',
    'customer' => 'Customer',
    'customer_help' => 'Whose samples these are. Assignable equipment comes from this customer.',
    'sampler' => 'Sampler',
    'sampler_help' => 'Who drew the samples. Pick from the catalog, or type the external name in the next field.',
    'sampler_name' => 'Sampler (external)',
    'authorized_by' => 'Authorizes sample intake',
    'authorized_by_help' => 'Who at the laboratory authorizes the sample in. The list comes from the signature catalog, flagged "Authorizes intake".',
    'authorized_by_empty' => 'Nobody is enabled to authorize intake. Flag "Authorizes intake" in the signature catalog.',
    ...
    'due_at_help' => 'When the result is committed for. Cannot be earlier than the reception date.',
    'days_left' => 'Days left',
    'service_order_pending' => 'Pending',
    'packages' => 'Containers received',
    'packages_help' => 'How many containers the delivery brings. It is the count proposed when confirming samples.',
    'is_urgent' => 'Urgent',
    'notes' => 'Notes',
