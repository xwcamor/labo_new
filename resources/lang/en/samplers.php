...
return [
    ...
    'index_title'    => 'Samplers',
    'index_subtitle' => 'Who can take a sample: the laboratory own areas, the customer and third parties. It is what the report prints under "Sample taken by".',
    'create_title'   => 'Create sampler',
    'create_subtitle'=> 'Fill in the data to create a new sampler.',
    'edit_title'     => 'Edit sampler',
    'delete_title'   => 'Delete sampler',
    'show_title'     => 'Sampler — Details',
    'trash_title'    => 'Samplers trash',
    'form_create_hint' => 'Fill in the data to create a new sampler.',
    'empty_hint'      => 'Create your first sampler or import a batch from Excel.',
    'name_placeholder' => 'E.g.: FIELD SERVICE, CUSTOMER, SUBCONTRACTOR',

    'name'      => 'Name',
    'name_help' => 'Who took the sample: a laboratory area, the customer or a third party. It is what the report prints under "Sample taken by".',
    'code'      => 'Code',
    'code_help' => 'Catalog code. In the previous system it was the order number (1..12).',
    'sort_order' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the sampler will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'created' => 'Sampler created.',
    'saved'   => 'Sampler updated.',
    'deleted' => 'Sampler deleted.',
    ...
    'export_filename'           => 'samplers_export',
    'import_template_filename'  => 'samplers-template.xlsx',
    'export_title'              => 'Samplers Report',
    ...
    'name_unique'              => 'This sampler already exists.',
    'code_unique'              => 'An sampler with this code already exists.',
    ...
    'edit_all_title'    => 'Samplers — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple samplers at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No samplers match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to Samplers',
        'step1_body'  => 'This is the samplers catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',
