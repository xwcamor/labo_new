...
return [
    ...
    'code'            => 'N° de recepción',
    'code_help'       => 'Se genera solo al guardar (REC-año-número). No es el número de las muestras.',
    ...
    'sampler'         => 'Muestreador',
    'sampler_help'    => 'Quién tomó las muestras. Elija del catálogo, o escriba el nombre del externo en el campo de al lado.',
    'sampler_name'    => 'Muestreador (externo)',
    'authorized_by'      => 'Autoriza el ingreso de la muestra',
    'authorized_by_help' => 'Quién del laboratorio autoriza que la muestra entre. La lista sale del catálogo de firmas, marcando «Autoriza ingresos».',
    'authorized_by_empty' => 'No hay nadie habilitado para autorizar ingresos. Marque «Autoriza ingresos» en el catálogo de firmas.',
    ...
    'due_at_help'     => 'Para cuándo se compromete el resultado. No puede ser anterior a la fecha de recepción.',
    'days_left'       => 'Días restantes',
    'service_order_pending' => 'Pendiente',
    'packages'        => 'Envases recibidos',
    'packages_help'   => 'Cuántos frascos trae la entrega. Es la cantidad que se propone al confirmar las muestras.',
    'is_urgent'       => 'Urgente',
    'notes'           => 'Observaciones',
