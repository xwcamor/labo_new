...
return [
    'singular'      => 'Muestreador',
    'plural'        => 'Muestreadores',
    'record'        => 'muestreador',
    'records'       => 'muestreadores',
    'new'           => 'Crear muestreador',
    'id'            => 'N°',

    'index_title'    => 'Muestreadores',
    'index_subtitle' => 'Quién puede tomar una muestra: áreas propias del laboratorio, el cliente y terceros. Es lo que el informe imprime en "Muestra extraída por".',
    'create_title'   => 'Crear muestreador',
    'create_subtitle'=> 'Completa los datos para crear un nuevo muestreador.',
    'edit_title'     => 'Editar muestreador',
    'delete_title'   => 'Eliminar muestreador',
    'show_title'     => 'Muestreador — Información',
    'trash_title'    => 'Papelera de muestreadores',
    'form_create_hint' => 'Completa los datos para crear un nuevo muestreador.',
    'empty_hint'      => 'Crea el primer muestreador o importa un lote desde Excel para empezar.',
    'name_placeholder' => 'Ej: SERVICE CAMPO, CLIENTE, SUBCONTRATISTA',

    'name'      => 'Nombre',
    'name_help' => 'Quién tomó la muestra: un área del laboratorio, el cliente o un tercero. Es lo que el informe imprime en "Muestra extraída por".',
    'code'      => 'Código',
    'code_help' => 'Código del catálogo. El del sistema anterior era el número de orden (1..12).',
    'sort_order' => 'Orden',
    'is_active' => 'Estado',
    'is_active_help' => 'Si está inactivo, el muestreador no aparecerá en los selectores de otros módulos.',
    'filter_name' => 'Nombre',
    ...
    'created' => 'Muestreador creado.',
    'saved'   => 'Muestreador actualizado.',
    'deleted' => 'Muestreador eliminado.',
    ...
    // Export
    'export_filename'           => 'exportacion_muestreadores',
    'import_template_filename'  => 'plantilla-muestreadores.xlsx',
    'export_title'              => 'Reporte de Muestreadores',
    ...
    'name_unique'              => 'Este muestreador ya existe.',
    'code_unique'              => 'Ya existe un muestreador con este código.',
    ...
    // Edit All
    'edit_all_title'    => 'Muestreadores — Editar Todo',
    'edit_all_subtitle' => 'Edita nombre y estado de muchos muestreadores a la vez. Click "Guardar todo" para confirmar, "Cancelar" para descartar.',
    ...
    'edit_all_no_results' => 'No hay muestreadores que coincidan con el filtro.',
    ...
    // Onboarding tour
    'tour' => [
        'step1_title' => 'Bienvenido a Muestreadores',
        'step1_body'  => 'Este es el catálogo de muestreadores. Te mostramos los puntos clave en menos de 1 minuto.',
        'step2_title' => 'Filtros',
        ...
        'step4_body'  => 'Muestra/oculta columnas y se recuerda tu elección. Las muestreadordas como "obligatorias" no se pueden ocultar.',
        ...
        'step7_body'  => 'La estrella ★ muestreador un registro como favorito. Los favoritos aparecen siempre arriba del listado y cada usuario tiene los suyos.',
