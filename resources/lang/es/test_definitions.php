...
return [
    ...
    'code'      => 'Código',
    'code_help' => 'Identificador técnico de la prueba (ej: numero_acido). Se escribe solo a partir del nombre y es único en todo el sistema: los cuadros de límites, el mapa de analitos y las cartas de control apuntan a él.',
    'code_changes_title' => 'Al renombrar la prueba cambia su código',
    'code_changes_help'  => 'El código pasa de «:from» a «:to». Es la clave a la que apuntan el cuadro de límites, el mapa de analitos, la política de control de calidad y las cartas de control: si algo quedó atado al código anterior, hay que repuntarlo.',
    'group'     => 'Grupo',
