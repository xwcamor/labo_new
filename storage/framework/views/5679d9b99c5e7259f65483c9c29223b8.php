                ...
                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td>
                                <?php switch($col):
                                    case ('id'): ?>         <?php echo e($b->id); ?> <?php break; ?>
                                    <?php case ('name'): ?>       <?php echo e($b->name); ?> <?php break; ?>
                                    <?php case ('code'): ?>       <?php echo e($b->code ?? ''); ?> <?php break; ?>
                                    <?php case ('sort_order'): ?> <?php echo e($b->sort_order ?? ''); ?> <?php break; ?>
                                    <?php case ('is_active'): ?>
                                        <span class="<?php echo e($b->is_active ? 'status-active' : 'status-inactive'); ?>">
                                            <?php echo e($b->state_text); ?>

                                        </span>
                                    <?php break; ?>
                                    <?php case ('slug'): ?>       <?php echo e($b->slug); ?> <?php break; ?>
                                    <?php case ('created_at'): ?> <?php echo e($b->created_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('updated_at'): ?> <?php echo e($b->updated_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('creator'): ?>    <?php echo e($b->creator->name ?? '—'); ?> <?php break; ?>
                                    <?php default: ?> <?php echo e($b->{$col} ?? ''); ?>
...
<?php /**PATH /workspace/labo_new/resources/views/business_management/brands/pdf/template.blade.php ENDPATH**/ ?>