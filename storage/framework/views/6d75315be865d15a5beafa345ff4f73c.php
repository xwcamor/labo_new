...
<body>
    ...
    <?php
        $headings = [
            'id'         => __('equipment_types.id'),
            'name'       => __('equipment_types.name'),
            'code'       => __('equipment_types.code'),
            'sort_order' => __('equipment_types.sort_order'),
            'is_active'  => __('equipment_types.is_active'),
            'slug'       => 'Slug',
    ...
    <?php else: ?>
        <table class="data">
            ...
            <tbody>
                <?php $__currentLoopData = $equipment_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td>
                                <?php switch($col):
                                    case ('id'): ?>         <?php echo e($tt->id); ?> <?php break; ?>
                                    <?php case ('name'): ?>       <?php echo e($tt->name); ?> <?php break; ?>
                                    <?php case ('code'): ?>       <?php echo e($tt->code ?? ''); ?> <?php break; ?>
                                    <?php case ('sort_order'): ?> <?php echo e($tt->sort_order ?? ''); ?> <?php break; ?>
                                    <?php case ('is_active'): ?>
                                        <span class="<?php echo e($tt->is_active ? 'status-active' : 'status-inactive'); ?>">
                                            <?php echo e($tt->state_text); ?>

                                        </span>
                                    <?php break; ?>
                                    <?php case ('slug'): ?>       <?php echo e($tt->slug); ?> <?php break; ?>
                                    <?php case ('created_at'): ?> <?php echo e($tt->created_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('updated_at'): ?> <?php echo e($tt->updated_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('creator'): ?>    <?php echo e($tt->creator->name ?? '—'); ?> <?php break; ?>
                                    <?php default: ?> <?php echo e($tt->{$col} ?? ''); ?>
...
<?php /**PATH /workspace/labo_new/resources/views/business_management/equipment_types/pdf/template.blade.php ENDPATH**/ ?>