...
<body>
    ...
    <?php else: ?>
        <table class="data">
            ...
            <tbody>
                <?php $__currentLoopData = $transformer_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td>
                                <?php switch($col):
...
<?php /**PATH /workspace/labo_new/resources/views/business_management/transformer_types/pdf/template.blade.php ENDPATH**/ ?>