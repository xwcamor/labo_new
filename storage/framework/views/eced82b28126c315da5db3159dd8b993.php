...
<body>
    ...
    <?php else: ?>
        <table class="data">
            ...
            <tbody>
                <?php $__currentLoopData = $oil_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td>
                                <?php switch($col):
                                    case ('id'): ?>         <?php echo e($ot->id); ?> <?php break; ?>
                                    <?php case ('name'): ?>       <?php echo e($ot->name); ?> <?php break; ?>
                                    <?php case ('code'): ?>       <?php echo e($ot->code ?? ''); ?> <?php break; ?>
                                    <?php case ('sort_order'): ?> <?php echo e($ot->sort_order ?? ''); ?> <?php break; ?>
                                    <?php case ('is_active'): ?>
                                        <span class="<?php echo e($ot->is_active ? 'status-active' : 'status-inactive'); ?>">
                                            <?php echo e($ot->state_text); ?>

                                        </span>
                                    <?php break; ?>
                                    <?php case ('slug'): ?>       <?php echo e($ot->slug); ?> <?php break; ?>
                                    <?php case ('created_at'): ?> <?php echo e($ot->created_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('updated_at'): ?> <?php echo e($ot->updated_at?->copy()->setTimezone($tz ?? config('app.timezone'))->format(\App\Support\Tz::DATETIME_FORMAT)); ?> <?php break; ?>
                                    <?php case ('creator'): ?>    <?php echo e($ot->creator->name ?? '—'); ?> <?php break; ?>
                                    <?php default: ?> <?php echo e($ot->{$col} ?? ''); ?>
...
<?php /**PATH /workspace/labo_new/resources/views/business_management/oil_types/pdf/template.blade.php ENDPATH**/ ?>